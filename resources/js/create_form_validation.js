...
const validateForm = () => {
    ...
    if (nameValue === "") {
        wrongValue(nameInput, nameError, "Il nome del piatto è obbligatorio.");
    }
    ...
    if (priceValue === "") {
        wrongValue(priceInput, priceError, "Il prezzo è obbligatorio.");
        ...
        wrongValue(priceInput, priceError, "Il prezzo non è valido.");
    }
